...
/**
 * La classe Assembler est responsable de l'analyse et de l'exécution du code
 * assembleur.
 * Elle fournit des méthodes pour diviser le code assembleur en instructions
 * individuelles
...
public class Assembler {
    ...
    /**
     * Analyse le code assembleur fourni et le divise en une liste d'instructions
     * individuelles.
     *
     * @param code Le code assembleur à analyser, représenté sous forme de chaîne de
     *             caractères.
     * @return Une liste contenant chaque instruction du code assembleur, sans
     *         espaces inutiles.
     */
    ...
    /**
     * Analyse une ligne de code assembleur et extrait les arguments d'une
     * instruction.
     *
     * @param line La ligne de code contenant l'instruction et ses arguments.
     * @return un tableau contenant les arguments de l'instruction, sans
     *         l'instruction elle-même.
     */
    public String[] parseArguments(String line) {
        String[] parts = line.split("\\s+");
        String[] arguments = new String[parts.length - 1];
        System.arraycopy(parts, 1, arguments, 0, arguments.length); // copier à partir de l'indice 1; part[0] est le nom
                                                                    // de l'instruction.
        return arguments;
    }
    ...
    /**
     * Exécute une série d'instructions sur un robot jusqu'à ce que le pointeur du
     * robot dépasse la taille des instructions.
     *
     * @param robot        Le robot sur lequel les instructions doivent être
     *                     exécutées.
     * @param instructions La liste des instructions à exécuter.
     * @throws Exception Si une erreur survient pendant l'exécution des
     *                   instructions.
     */
    public void execute(Robot robot, ArrayList<String> instructions) throws Exception {
        // Tant que le pointeur du robot est inférieur à la taille de la liste
        // d'instructions.
    ...
    /**
     * Exécute une seule instruction sur un robot, en fonction de l'instruction
     * fournie.
     *
     ...
     * @throws Exception Si une erreur survient pendant l'exécution de
     *                   l'instruction.
     */
    public void executeOne(Robot robot, String instruction, ArrayList<String> instructions) throws Exception {
        // Analyse les arguments de l'instruction et crée un objet Code représentant
        // l'instruction.
        ...
        // Switch sur l'instruction pour exécuter le bon bloc de code en fonction de
        // l'instruction.
        ...
        // Incrémente le pointeur du robot pour passer à l'instruction suivante dans la
